...
if ( ! function_exists( 'new_blog_setup' ) ) :
	...
	function new_blog_setup() {
		...
		add_image_size('new-blog-feature-display-thumbnail', 361, 175, array( 'center','center'));
		add_image_size('new-blog-blog-display-thumbnail', 360, 250, array( 'center','center'));
...
function new_blog_scripts() {
	...
	wp_enqueue_script( 'jquery1124-js', get_template_directory_uri() . '/js/jquery-1.12.4.js', array(), '20151215', true );
